...
public class ComplianceController {
	...
	public List<Compliance> f2() {
		return this.service.getAllCompliances();
	}

	@PostMapping(value = "/statusreport")
	public void f3(@RequestBody StatusReport statusreport) {
		this.service.createStatusReport(statusreport);
	}
}